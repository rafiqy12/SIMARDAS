    ...
    <header>
        ...
        <div class="header-gradient py-2 border-bottom shadow-sm">
            <div class="container d-flex align-items-center">
                <img src="{{ asset('images/Logo_kabupaten_serang2.png') }}" alt="Logo" width="45" class="me-2 d-none d-sm-block">
                <img src="{{ asset('images/Logo_kabupaten_serang2.png') }}" alt="Logo" width="35" class="me-2 d-sm-none">
            ...
            <div class="row gy-4">
                ...
                <div class="col-md-3">
                    <div class="d-flex mb-3">
                        <img src="{{asset('images/Logo_kabupaten_serang2.png')}}" width="60" class="me-2" alt="Logo">
                        <div>
                ...
                <div class="col-md-3">
                    ...
                    <ul class="list-unstyled small">
                        ...
                        <li><a href="{{ route('search.page') }}" class="text-white text-decoration-none d-block mb-2 opacity-75"><i class="bi bi-chevron-right me-1"></i>Cari Arsip</a></li>
                        <li><a href="{{ route('scan.barcode.page') }}" class="text-white text-decoration-none d-block mb-2 opacity-75"><i class="bi bi-chevron-right me-1"></i>Scan Barcode</a></li>
                        @else
                        <li><a href="{{ route('login.page') }}" class="text-white text-decoration-none d-block mb-2 opacity-75"><i class="bi bi-chevron-right me-1"></i>Login</a></li>
                        <li><a href="{{ route('register.page') }}" class="text-white text-decoration-none d-block mb-2 opacity-75"><i class="bi bi-chevron-right me-1"></i>Register</a></li>
                        @endauth
                    </ul>
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <ul class="list-unstyled small">
                        ...
                        <li><a href="{{ route('dokumen_upload.page') }}" class="text-white text-decoration-none d-block mb-2 opacity-75"><i class="bi bi-chevron-right me-1"></i>Upload Arsip</a></li>
                        <li><a href="{{ route('dokumen.index') }}" class="text-white text-decoration-none d-block mb-2 opacity-75"><i class="bi bi-chevron-right me-1"></i>Manajemen Arsip</a></li>
                        <li><a href="{{ route('scan_dokumen.page') }}" class="text-white text-decoration-none d-block mb-2 opacity-75"><i class="bi bi-chevron-right me-1"></i>Upload Dokumen via Scan</a></li>
                        @endif
