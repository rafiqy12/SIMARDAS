        ...
        <div class="row gy-4">
            ...
            <div class="col-md-3">
                ...
                <ul class="list-unstyled small">
                    ...
                    <li><a href="{{ route('search.page') }}" class="text-white text-decoration-none d-block mb-1">Cari Arsip</a></li>
                    <li><a href="{{ route('scan.barcode.page') }}" class="text-white text-decoration-none d-block mb-1">Scan Barcode</a></li>
                    @else
                    <li><a href="{{ route('login.page') }}" class="text-white text-decoration-none d-block mb-1">Login</a></li>
                    <li><a href="{{ route('register.page') }}" class="text-white text-decoration-none d-block mb-1">Register</a></li>
                    @endauth
                </ul>
            </div>
            ...
            <div class="col-md-3">
                ...
                <ul class="list-unstyled small">
                    ...
                    <li><a href="{{ route('dokumen_upload.page') }}" class="text-white text-decoration-none d-block mb-1">Upload Arsip</a></li>
                    <li><a href="{{ route('dokumen.index') }}" class="text-white text-decoration-none d-block mb-1">Manajemen Arsip</a></li>
                    <li><a href="{{ route('scan_dokumen.page') }}" class="text-white text-decoration-none d-block mb-1">Upload Dokumen via Scan</a></li>
                    @endif
                    <li><a href="{{ route('search.page') }}" class="text-white text-decoration-none d-block mb-1">Pencarian Dokumen</a></li>
                    <li><a href="{{ route('scan.barcode.page') }}" class="text-white text-decoration-none d-block mb-1">Scan Barcode</a></li>
                    @endauth
                </ul>
            </div>
